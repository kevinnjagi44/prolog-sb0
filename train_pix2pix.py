...
dataloader = DataLoader(oct_cheng_dataset("/root/datasets/%s" % opt.dataset_name, transforms_=transforms_),
                        batch_size=opt.batch_size, shuffle=True, num_workers=opt.n_cpu)

val_dataloader = DataLoader(oct_edema_dataset("/root/datasets/%s" % opt.val_dataset_name, transforms_=transforms_),
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        vis.plot_legend('Genertor-train', [loss_G.data, loss_GAN.data, loss_pixel.data],
                        ['G_loss', 'loss_GAN', 'loss_pixel'])
        loss_G.backward()
        ...
        vis.plot_legend('Discriminator-train', [loss_D.data, loss_real.data, loss_fake.data],
